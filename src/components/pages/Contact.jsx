      ...
      <Container>
        <Flex className="pt-[110px] md:pt-[130px] flex-col lg:flex-row gap-10">
          ...
          <div className="w-full  lg:w-1/2" data-aos="fade-right">
            ...
            {/* LinkedIn */}
            <a className="inline-block group w-full" href="#">
            ...
            {/* Email */}
            <a className="inline-block group w-full mt-5" href="#">
              <div className="flex gap-4 items-center">
          ...
          <div className="w-full lg:w-1/2">
            <div
              className="relative p-6 rounded-3xl bg-[#0f0f0f] border border-gray-800 
    shadow-[0_0_40px_rgba(192,38,211,0.15)] overflow-hidden"
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-[#1a1a1a] text-white 
          border border-gray-700
          focus:outline-none focus:border-fuchsia-600 focus:ring-1 focus:ring-fuchsia-600"
                  />
        ...
        focus:outline-none focus:border-fuchsia-600 focus:ring-1 focus:ring-fuchsia-600"
                ...
                <button
                  type="submit"
                  className="w-full bg-fuchsia-600 hover:bg-fuchsia-700 text-white py-3 rounded-xl 
        shadow-[0_0_20px_rgba(192,38,211,0.4)] transition"
                >
